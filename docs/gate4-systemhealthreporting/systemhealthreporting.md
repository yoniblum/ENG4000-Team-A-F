...
**Figure9 shows the transition system model of this application. It visualizes operation modes of various components that the system is comprised of. Though not correct in principle, I use the red (arrow) edge to identify a constraint, for my convinience.**
